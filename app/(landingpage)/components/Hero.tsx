...
export function Heading() {
    return (
        <motion.h1
            ...
            className="text-4xl font-semibold text-neutral-700 dark:text-white px-4 md:text-4xl lg:text-5xl max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto "
        >
