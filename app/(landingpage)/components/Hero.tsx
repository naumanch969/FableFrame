...
export function Heading() {
    return (
        <motion.h1
            ...
            className="text-4xl font-semibold text-surface-foreground dark:text-surface-foreground px-4 lg:px-0 md:text-4xl lg:text-5xl max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto "
        >
